...
namespace assignment_23
{
	...
	class Customer
	{
		...
		public override string ToString()
			=> $"CustomerID: {CustomerID}, CustomerName: {CustomerName}, Address: {Address}, City: {City}, Region: {Region}, PostCode: {PostalCode}, Country: {Country}, Phone: {Phone}, Fax: {Fax}";
	}
	class Order
	{
    ...
    class CustomWordComparer : IComparer<string>
    {
        public int Compare(string x, string y)
        {
            ...
            //if lengths are the same then do a case-insensitive comparison
